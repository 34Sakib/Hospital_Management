...
@section('title', 'Favorites - Hospital Management')
...
<div class="container">
    <aside class="sidebar">
        <nav>
            ...
            <a href="{{ route('appointment.index') }}"><span class="icon">📅</span> Appointments</a>
            <a href="{{ route('favorite.index') }}" class="active"><span class="icon">❤️</span> Favorite Doctor</a>
            <a href="{{ route('service.index') }}"><span class="icon">🕑</span> Service History</a>
        </nav>
    </aside>
